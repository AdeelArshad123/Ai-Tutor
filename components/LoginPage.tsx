        ...
        <div className="flex-grow flex items-center justify-center p-4">
            <div className={`relative w-full max-w-md rounded-2xl p-8 md:p-10 ${styles.card}`}>
                <div className="text-center mb-8">
                     ...
                     <p className="mt-4 text-2xl font-semibold text-gray-900 dark:text-white">Welcome Back</p>
                     <p className="mt-2 text-base text-gray-600 dark:text-gray-400">Log in to continue your journey.</p>
                </div>
                ...
                <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <button onClick={onNavigateToSignup} className={`font-medium ${styles.link}`}>
                        Sign up
                    </button>
                </p>
            </div>
